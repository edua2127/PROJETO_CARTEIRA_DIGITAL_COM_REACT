...
const EditorPeriodo = () => {
  ...
  function handleAplicarFiltro() {
    ...
    filtroDespesasExibidas = filtroDespesasExibidas.filter((despesaAtual) => {
      ...
      return (
        dataDespesaTime >= dataInicialTime && dataDespesaTime <= dataFinalTime
      );
    });
  ...
  return (
    <section
      className={style.home_end_page}
      data-testid="editor-periodo-test-id"
    >
      <article className={style.home_article_edicao_data}>
        <label>
          ...
          <input
            ...
            data-testid="input-periodo-inicial-test-id"
        ...
        <label>
          ...
          <input
            type={"date"}
            className={style.home_input}
            data-testid="input-periodo-final-test-id"
        ...
        <input
          type={"submit"}
          data-testid="input-submit-test-id"
          className={style.home_input}
