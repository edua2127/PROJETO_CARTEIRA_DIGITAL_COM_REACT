...
export const selectAplicarFiltro = (state: RootState) =>
  state.geral.aplicarFiltro;
export const selectDespesasExibidas = (state: RootState) =>
  state.geral.despesasExibidas;
export const selectPeriodoFinal = (state: RootState) =>
  state.geral.periodoFinal;
export const selectPeriodoInicial = (state: RootState) =>
  state.geral.periodoInicial;
export const selectValor = (state: RootState) => state.geral.valor;
export const selectMetodoDePagamento = (state: RootState) =>
  state.geral.metodoDePagamento;
...
export const selectAtualizaValorDolar = (state: RootState) =>
  state.geral.atualizaValorDolar;
export const selectDataAtualDoFiltro = (state: RootState) =>
  state.geral.dataAtualDoFiltro;
export const selectDataDaDespesa = (state: RootState) =>
  state.geral.dataDaDespesa;
